...
Request.prototype.create = function () {
  ...
  var calculateTimestamp = function(){
    ...
    var requestDuration = responseTime - sendTime;
    debug_browser.add_timestamp(requestDuration);
    xhr._requestDuration = requestDuration;
  }
  ...
  if (this.xd && global.XDomainRequest && xhr instanceof XDomainRequest) {
    ...
    xhr.onreadystatechange = function () {
      ...
      try {
        // readyState 2: means HEADERS_RECEIVED
        if (xhr._requestDuration === undefined && self._requestType === "write") {
            calculateTimestamp();
        }
